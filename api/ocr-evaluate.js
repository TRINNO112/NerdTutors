...
- STRICT SCORE CAPPING FOR BREVITY: For 3-mark or higher questions, if the student's answer is very brief (e.g., under 4 lines or under 40 words), the ABSOLUTE MAXIMUM score you can award is 1.5 out of 3. You are strictly forbidden from awarding higher partial marks (like 2 or 2.5) for short answers.
- STRICT NUMERICAL COMPLETENESS: For numerical/calculation questions, if the student sets up the cases correctly but fails to explicitly calculate the final change, difference, or comparison amount as required by the marking scheme, you MUST deduct 50% of the total marks automatically.
