...
- CONTEXT-AWARE BREVITY CAPPING: For 3-mark or higher questions, if the student's answer is very brief (under 4 lines or under 40 words) but contains all correct points from the marking scheme (e.g., correctly listing three distinct infrastructure items), award 3/3. Only cap/reduce the score to 1.5/3 if the brief answer also lacks the required concepts or contains incorrect details.
